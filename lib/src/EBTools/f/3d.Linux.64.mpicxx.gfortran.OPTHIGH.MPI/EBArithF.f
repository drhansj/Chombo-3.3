     ...
     &o1+1)*(iregionhi2- iregionlo2+1) + counter*(pval+1)
      return
      end
     ...
     & src(i,j,k,nsrc)
      ...
      enddo
      ch_flops=ch_flops+(iregionhi0- iregionlo0+1)*(iregionhi1- iregionl
     &o1+1)*(iregionhi2- iregionlo2+1)*numcomp
      return
      end
     ...
     & src(i,j,k,nsrc) * scale
      ...
      enddo
      ch_flops=ch_flops+(iregionhi0- iregionlo0+1)*(iregionhi1- iregionl
     &o1+1)*(iregionhi2- iregionlo2+1)*2*numcomp
      return
      end
      subroutine AXBYFAB(
     & dst
     ...
     & + y(i,j,k,nsrc) * b
      ...
      enddo
      ch_flops=ch_flops+(iregionhi0- iregionlo0+1)*(iregionhi1- iregionl
     &o1+1)*(iregionhi2- iregionlo2+1)*3*numcomp
      return
      end
     ...
     & + y(i,j,k,ycomp) * b
      ...
      enddo
      ch_flops=ch_flops+(iregionhi0- iregionlo0+1)*(iregionhi1- iregionl
     &o1+1)*(iregionhi2- iregionlo2+1)*3
      return
      end
     ...
     & dst(i,j,k,n) - src
      ...
      enddo
      ch_flops=ch_flops+(iregionhi0- iregionlo0+1)*(iregionhi1- iregionl
     &o1+1)*(iregionhi2- iregionlo2+1)*ncompdst
      return
      end
      subroutine ADDFABR(
     & dst
