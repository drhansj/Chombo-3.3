...
#include "CONSTANTS.H"
     ...
     &           0:nvolfraccomp-1)
      ...
      enddo
      enddo
      ch_flops=ch_flops+(iregionhi0- iregionlo0+1)*(iregionhi1- iregionlo1+1) + counter*(pval+1)
      return
      end
     ...
     &        src(i,j,nsrc)
      ...
      enddo
         ndest = ndest + 1
      enddo
      ch_flops=ch_flops+(iregionhi0- iregionlo0+1)*(iregionhi1- iregionlo1+1)*numcomp
      return
      end
     ...
     &        src(i,j,nsrc) * scale
      ...
      enddo
         ndest = ndest + 1
      enddo
      ch_flops=ch_flops+(iregionhi0- iregionlo0+1)*(iregionhi1- iregionlo1+1)*2*numcomp
      return
      end
      subroutine AXBYFAB(
     &           dst
     ...
     &      + y(i,j,nsrc) * b
      ...
      enddo
         ndest = ndest + 1
      enddo
      ch_flops=ch_flops+(iregionhi0- iregionlo0+1)*(iregionhi1- iregionlo1+1)*3*numcomp
      return
      end
     ...
     &     + y(i,j,ycomp) * b
      ...
      enddo
      enddo
      ch_flops=ch_flops+(iregionhi0- iregionlo0+1)*(iregionhi1- iregionlo1+1)*3
      return
      end
     ...
     &        dst(i,j,n) - src
      ...
      enddo
      enddo
      ch_flops=ch_flops+(iregionhi0- iregionlo0+1)*(iregionhi1- iregionlo1+1)*ncompdst
      return
      end
      subroutine ADDFABR(
     &           dst
