...
#include "CONSTANTS.H"
     ...
     &           icoarlevello2:icoarlevelhi2)
      ...
      enddo
      enddo
        ch_flops=ch_flops+(irefboxhi0- irefboxlo0+1)*(irefboxhi1- irefboxlo1+1)*(irefboxhi2- irefboxlo2+1)*(icoarboxhi0- icoarboxlo0+1)*(icoarboxhi1- icoarboxlo1+1)*(icoarboxhi2- icoarboxlo2+1)
        return
        end
