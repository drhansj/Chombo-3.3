...
#include "CONSTANTS.H"
     ...
     &       +  weight*fine(iif,jjf,kkf)
      ...
      enddo
      enddo
        ch_flops=ch_flops+(icoarboxhi0- icoarboxlo0+1)*(icoarboxhi1- icoarboxlo1+1)*(icoarboxhi2- icoarboxlo2+1)*(irefboxhi0- irefboxlo0+1)*(irefboxhi1- irefboxlo1+1)*(irefboxhi2- irefboxlo2+1)*(2+CH_SPACEDIM)
        return
        end
